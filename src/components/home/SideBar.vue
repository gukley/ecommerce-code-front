<template> 
    <div class="sidebar text-white p-4 d-flex flex-column rounded-4"> 
        ...
        <div class="mt-auto mt-5 p-4 rounded-3 text-cemter offer-box-promo"> 
            <i class="bi bi-fire text-warning fs-3 mb-2 animate-pulse-fast"></i>
            <p class="mb-1 fw-bold fs-5">Oferta Especial</p> 
            <small class="text-white-75">Até 50% OFF em produtos selecionados</small>
            <button class="btn btn-sm btn-offer-action mt-3 fw-bold">Ver Ofertas</button> 
        </div>
    </div>
</template>
...
.offer-box-promo p, .offer-box-promo small { 
    position: relative;
    z-index: 1;
}
