  ...
  <div class="product-detail-page bg-dark text-white min-vh-100 py-5">
    <div class="container">
      <button
        ...
        class="btn btn-outline-primary mb-4 d-flex align-items-center gap-2"
      ...
      <div v-else-if="produto" class="row g-5 align-items-start">
        <div class="col-md-6 text-center">
          <img
            :src="produto.image_path ? BASE_URL + produto.image_path : '/placeholder-product.png'"
        ...
        <div class="col-md-6">
          ...
          <div class="mb-3">
            <span class="badge bg-success me-2" v-if="produto.stock > 0" aria-live="polite">
